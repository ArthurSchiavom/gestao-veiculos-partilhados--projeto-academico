...
public class ParkTest {
    ...
    public void testGetParkInputVoltage() {
        ...
        cp.add(cap);
        Park instance = new Park("new park", 10.2f, 10.1f, cp,
                "cool park", coord);
    ...
    public void getAmountOccupiedByType_01() {
        ...
        try {
            instance.getAmountOccupiedByType(VehicleType.ELECTRIC_SCOOTER);
            fail();
    ...
    @Test
    void testGetAmountSlotsFreedByType() {
        Capacity cap = new Capacity(30, 20, VehicleType.BICYCLE);
        Coordinates coord = new Coordinates(0, 0, 0);
        List<Capacity> cp = new ArrayList<>();
        cp.add(cap);
        Park instance = new Park("new park", 10.2f,
                10.1f, cp, "cool park", coord);
        assertEquals(10, instance.getAmountSlotsFreeByType(VehicleType.BICYCLE));
    }
}
