...
public class PhysicsMethods {
     ...
     * @param cosApparentWindAngle - the angle made between the wind speed direction and the vehicle
     * 
     ...
     * @param startPoint - the starting point of the path that the rider is
     * going
     * @param endPoint - the ending point of the path that the rider is going
     * @param windAngle - the angle made between the wind speed direction and the vehicle
     * 
