...
public class ElectricScooter extends Vehicle {
    ...
    public ElectricScooter(int id, String name, double latitude, double longitude, double altitude, boolean available, VehicleType type, float batteryLevel, ScooterType scooterType) {
