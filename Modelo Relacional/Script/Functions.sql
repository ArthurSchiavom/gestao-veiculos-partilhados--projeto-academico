...
BEGIN
	SELECT v.DESCRIPTION, v.vehicle_type_name, v.available, v.weight, v.aerodynamic_coefficient, v.frontal_area
	INTO vehicle
	FROM vehicles v 
	INNER JOIN park_vehicle pv 
	ON pv.VEHICLE_DESCRIPTION=v.DESCRIPTION AND pv.park_id=start_park_id_in
...
BEGIN
	...
	UPDATE vehicles SET available = true WHERE DESCRIPTION=vehicle_description_in;
...
begin
    dbms_output.put_line(find_user_email_riding('PT001'));
end;
/